...
import 'package:to_do_app/App/Modules/Details/widgets/doing_list.dart';
import 'package:to_do_app/App/Modules/Details/widgets/done_list.dart';
...
class DetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var color = HexColor.fromHex(task.color.substring(3));
    return WillPopScope(
